...
{
    /// <summary> 
    /// Temp Helper class for logging messages in RecycleScrollView.
    /// You should replace it with your own logger if you have one.
    ///  </summary>
    public static class RecycleScrollLogger
    {
